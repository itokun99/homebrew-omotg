class Omotg < Formula
  ...
  url "https://github.com/itokun99/omotg/archive/refs/tags/v0.7.0.tar.gz"
  sha256 "c23115e8ae3fd6a6031fb44cd2c19b8e97afa35d531c8ec049310df082a24db6"
  ...
  def caveats
    <<~EOS
      OMOTG v0.7.0 installed! Next steps:
